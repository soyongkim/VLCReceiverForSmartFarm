...
package com.example.yuyangvlcdemo.lib.util;
...
public class SerialInputOutputManager implements Runnable {
    ...
    private static final String TAG = com.example.yuyangvlcdemo.lib.util.SerialInputOutputManager.class.getSimpleName();
    ...
    public interface Listener {
        ...
        /**
         * Called when {@link com.example.yuyangvlcdemo.lib.util.SerialInputOutputManager#run()} aborts due to an
         * error.
         */
